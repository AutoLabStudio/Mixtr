...
const mockMixologists: Mixologist[] = [
  {
    ...
    hourlyRate: 150,
    maxGuests: 150,
    certifications: "Certified Advanced Mixologist, Whiskey Master",
    experience: "Previously lead bartender at The NoMad Hotel in NYC and bar manager at The American Bar in London. Winner of World Class Bartender of the Year 2022.",
    availability: true,
    featured: true
  },
  {
    ...
    hourlyRate: 125,
    maxGuests: 120,
    certifications: "Certified Herbalist, Sustainable Bartending Certificate",
    experience: "Created the botanical program at The Botanist's Garden. Previously worked at Dandelyan in London. Author of 'From Garden to Glass: A Mixologist's Guide to Botanical Cocktails'.",
    availability: true,
    featured: true
  },
  {
    ...
    hourlyRate: 110,
    maxGuests: 80,
    certifications: "Certified Coffee Master, Mixology Innovation Award",
    experience: "Creator of the popular 'Caffeinated Dreams' cocktail menu. Known for theatrical presentations and unique serving vessels.",
    availability: true,
    featured: false
  },
  {
    ...
    barId: 3,
    barName: "Aperitivo Social",
    rating: 4.9,
    yearsOfExperience: 9,
    hourlyRate: 140,
    maxGuests: 100,
    certifications: "Italian Aperitivo Specialist, Sommelier Level 2",
    experience: "Trained at historic bars in Venice and Milan. Created signature aperitivo programs for luxury hotels across Europe.",
    availability: true,
    featured: true
  }
];
